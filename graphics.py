...
vert_clair=pygame.Color('light green')
gris=pygame.Color('grey')
bleu_clair=pygame.Color('light blue')
rouge_fonce=pygame.Color('dark red')
bleu_fonce=pygame.Color('dark blue')
vert_fonce=pygame.Color('dark green')
